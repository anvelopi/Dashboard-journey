...
function defaultArchetypes() {
  return [
    {id:"A1",name:"El Preparador de Temporada",icon:"🏊",desc:"Propietario que activa su piscina en abril-mayo. Depuradoras, filtros, químicos. Ticket €200-600.",pct:35,color:"#18181b"},
    {id:"A2",name:"El Manitas Reparador",icon:"🔧",desc:"Busca recambios exactos por referencia. Compra recurrente. Ticket €30-150.",pct:25,color:"#52525b"},
    {id:"A3",name:"El Automatizador Premium",icon:"⚡",desc:"Robots sin cable, cloradores salinos. Investiga mucho. Ticket €400-1.200.",pct:25,color:"#71717a"},
    {id:"A4",name:"El Técnico Profesional",icon:"🏗️",desc:"Bombas dosificadoras Seko, fotómetros. B2B.",pct:15,color:"#a1a1aa"},
  ];
}
...
function generateDashboardHTML(data: any, journey: any, aiEnabled: boolean, aiLoading: boolean): string {
  ...
  const archs=journey?.archetypes||[{id:"A1",name:"Perfil 1",icon:"\ud83d\udc64",desc:"Cargando...",pct:25,color:"#18181b"},{id:"A2",name:"Perfil 2",icon:"\ud83d\udc64",desc:"Cargando...",pct:25,color:"#52525b"},{id:"A3",name:"Perfil 3",icon:"\ud83d\udc64",desc:"Cargando...",pct:25,color:"#71717a"},{id:"A4",name:"Perfil 4",icon:"\ud83d\udc64",desc:"Cargando...",pct:25,color:"#a1a1aa"}];
...
*{margin:0;padding:0;box-sizing:border-box}body{font-family:var(--font);background:var(--bg);color:var(--text);line-height:1.5;font-size:14px;-webkit-font-smoothing:antialiased}
...
<tr style="background:rgba(9,9,11,.04)"><td style="padding:6px 8px;font-weight:700">${data.domain}</td><td style="text-align:right;padding:6px 8px;font-family:'Space Mono',monospace">${(domOvw.etv||0).toLocaleString()}</td><td style="text-align:right;padding:6px 8px;font-family:'Space Mono',monospace">${(domOvw.count||0).toLocaleString()}</td><td style="text-align:right;padding:6px 8px">\u2014</td></tr>
