...
.gap-mini{max-height:150px;overflow-y:auto;font-size:.75rem;color:var(--text2);scrollbar-width:thin}
.gap-mini-row{display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--surface3)}
...
<div class="kw-table-wrap" style="max-height:none;margin-bottom:12px"><table class="kw-table"><tr style="background:rgba(9,9,11,.06)"><th style="text-align:left;padding:6px 8px;font-size:.6rem;text-transform:uppercase;color:var(--text2)">Dominio</th><th style="text-align:right;padding:6px 8px;font-size:.6rem;text-transform:uppercase;color:var(--text2)">ETV</th><th style="text-align:right;padding:6px 8px;font-size:.6rem;text-transform:uppercase;color:var(--text2)">KWs</th><th style="text-align:right;padding:6px 8px;font-size:.6rem;text-transform:uppercase;color:var(--text2)">Shared</th></tr>
...
if(shared.length){h+='<div style="font-size:.56rem;font-weight:700;text-transform:uppercase;color:var(--text2);margin-bottom:4px">Win / Loss<\/div><div class="wl-grid"><div class="wl-box"><div class="wl-v" style="color:var(--success)">'+wins+'<\/div><div class="wl-l">Ganas t\u00fa<\/div><\/div><div class="wl-box"><div class="wl-v" style="color:#dc2626">'+losses+'<\/div><div class="wl-l">Gana '+dn+'<\/div><\/div><div class="wl-box"><div class="wl-v">'+fmt(bvol)+'<\/div><div class="wl-l">Vol. disputado<\/div><\/div><\/div>';
...
shared.sort(function(a,b){return b.vol-a.vol}).slice(0,10).forEach(function(s){var w=s.posQ>0&&s.posQ<=s.posC;h+='<tr><td style="padding:2px;border-bottom:1px solid rgba(0,0,0,.03)">'+s.kw+'<\/td><td style="text-align:right;font-family:var(--mono)">'+s.vol.toLocaleString()+'<\/td><td style="text-align:right;padding:2px;font-family:var(--mono);color:'+(w?'var(--success)':'var(--danger)')+';border-bottom:1px solid rgba(0,0,0,.03)">'+(s.posQ||'\u2014')+'<\/td><td style="text-align:right;padding:2px;font-family:var(--mono);color:'+(w?'var(--danger)':'var(--success)')+';border-bottom:1px solid rgba(0,0,0,.03)">'+s.posC+'<\/td><\/tr>'});h+='<\/table>'}
if(gapKws.length){h+='<div style="font-size:.56rem;font-weight:700;text-transform:uppercase;color:var(--text2);margin-bottom:4px;margin-top:6px">Gap exclusivo ('+fmt(gvol)+'/mes)<\/div><div class="gap-mini">';gapKws.sort(function(a,b){return b.vol-a.vol}).slice(0,10).forEach(function(g){h+='<div class="gap-mini-row"><span style="flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">'+g.kw+'<\/span><span style="font-family:var(--mono);color:var(--accent);font-weight:600;margin-left:6px">'+g.vol.toLocaleString()+'<\/span><\/div>'});h+='<\/div>'}
